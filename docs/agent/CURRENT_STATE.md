...
- **열 폭은 슬랙의 몫**(v37, `sideColumns.ts`): 왼 0.72 / 오른 0.28, 하한 136/52 · 상한 288/122.
  실측 1280 155/52 · 1440 163/52 · 1920 288/110 · 1905×858 288/122. 남는 몫의 절반만큼 열이
  **보드 쪽으로 붙는다**. 한 번의 측정이 CSS 변수 네 개를 심고 피치도 그 값을 읽는다.
...
5게이트 PASS(358 tests), 브라우저 216 checks ALL PASS(`pw/full-bleed` 37 — 레이아웃·발견성 계약 상시 감시).
