...
증거: `node pw/run.cjs` **140 checks ALL PASS**. 상세: CHG-20260824-194·195·196·197.
...
1. (해결됨, CHG-197) 사용자 보고 "같은 선수한테 또 공을 2번 이상 주면 반응을 안 해" — 원인은
   라이브 공의 순간이 항상 step 0으로 하드코딩된 것. 잡은 시각에서 파생하도록 고쳤다.
   이제 **단계 칩을 옮기면 공이 도착해 있는 프레임에 서고, 거기서 Alt+드래그하면 패스가 이어진다.**
...
- `npm test` → PASS (49 files / **348 tests**) — 2026-08-24
- `npm run build` → PASS — 2026-08-24
- `npm run harness:verify` → PASS (0 warnings) — 2026-08-24
- 브라우저 probe `node pw/run.cjs` (7종) → **140 checks ALL PASS**, 콘솔 클린 — 2026-08-24
